...
{
    PBSegmentView *sengMent = [[PBSegmentView alloc]initWithFrame:CGRectMake(0, 100, kScreenW/4.0*8, 45) withTitleArr:@[@"第一页☝️",@"第二页2⃣️",@"第三页3⃣️",@"第四页4⃣️",@"第五页5⃣️",@"第六页6⃣️",@"第七页7⃣️",@"第八页8⃣️"]];
